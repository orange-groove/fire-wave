...
export const metadata: Metadata = {
  title: 'Recording Delta Circle at Fire Wave Studio | Savannah Recording Session',
  description: 'A behind-the-scenes look at recording Delta Circle at Fire Wave Studio near Savannah, GA—how we built the record from a live scratch take.',
  keywords: ['Delta Circle', 'recording session', 'Savannah recording studio', 'Fire Wave Studio', 'band recording'],
  openGraph: {
    title: 'Recording Delta Circle at Fire Wave Studio',
    description: 'A behind-the-scenes look at recording Delta Circle at Fire Wave Studio near Savannah, GA.',
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Recording Delta Circle at Fire Wave Studio',
  description: 'A behind-the-scenes look at recording Delta Circle at Fire Wave Studio near Savannah, GA—how we built the record from a live scratch take.',
